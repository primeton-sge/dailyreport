...
(function( $ ) {
	...
	var DPGlobal = {
		...
		parseDate: function(date, format, language) {
			...
			// added by fick song for temp use
			if (format.toLocaleLowerCase() == 'yyyymmdd' && date.length == 8 && !isNaN(date)){
				var yearVal = date.substr(0,4);
				var monthVal = date.substr(4,2);
				var dayVal = date.substr(6,2);
				return UTCDate(yearVal, monthVal - 1, dayVal, 0, 0, 0);
			}
